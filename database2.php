...
// 에러 출력 설정 (개발 환경)
// 운영 환경에서는 false로 설정하고 에러 로그 파일에 기록
...
/**
 * VB의 Recordset.RecordCount와 유사한 기능
 * 
 * @param PDOStatement $stmt PDO Statement 객체
 * @return int 레코드 수
 */
function getRecordCount($stmt)
{
...
// 전역 PDO 객체를 사용할 수 있도록 export
// 다른 PHP 파일에서 require_once로 이 파일을 포함하면 $pdo 변수 사용 가능
